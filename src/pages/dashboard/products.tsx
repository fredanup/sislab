      ...
      <Layout>
        <div className="flex gap-2 flex-row md:justify-between justify-around">
          ...
          <div className="flex flex-row gap-2 md:gap-4 ml-auto">
            <button
              className="rounded-lg border border-gray-200 px-3 py-2 gap-2 text-gray-500 text-sm cursor-pointer flex flex-row items-center"
              onClick={(event) => {
            ...
            <button
              className="rounded-lg border border-gray-200 px-2 py-2 gap-2 text-gray-500 text-sm cursor-pointer flex flex-row items-center"
              onClick={(event) => {
                event.stopPropagation();
                openMovementModal();
              }}
